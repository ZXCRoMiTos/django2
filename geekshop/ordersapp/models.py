...
class Order(models.Model):
    ...
    status = models.CharField(verbose_name='статус', max_length=3, choices=ORDER_STATUS_CHOISES, default=FORMING)
    ...
    def get_total_cost(self):
        items = self.orderitems.select_related()
        return sum(list(map(lambda x: x.qty * x.product.price, items)))
